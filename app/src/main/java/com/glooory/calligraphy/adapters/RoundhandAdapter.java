...
public class RoundhandAdapter extends RecyclerView.Adapter<RoundhandAdapter.RoundhandItemHolder> {
    ...
    public RoundhandAdapter(Activity context) {
    ...
    private void initCharImageIds() {
        charImageIds = Constants.ROUNDHAND_CHAR_IDS;
    }
    ...
    @Override
    public void onBindViewHolder(RoundhandItemHolder holder, final int position) {
        ...
        holder.charImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Constants.IMAGE_PAGER_INDEX, Constants.ROUNDHAND_IMAGE_INDEX);
