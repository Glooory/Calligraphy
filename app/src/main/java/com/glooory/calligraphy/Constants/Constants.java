...
public class Constants {
    ...
    public static final String FRAGMENT_INDEX = "fragment_tpye";
    ...
    public static final int FLOURISHING_IMAGE_INDEX = 11;
    public static final int ITALIC_IMAGE_INDEX = 12;
