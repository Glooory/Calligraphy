 ...
 */
public class FlourishingWorksFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((GridView) listView).setAdapter(new GridViewAdapter(getActivity(), GridViewAdapter.FLOURISHING_GRIDVIEW));
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(getActivity(), ImagePagerActivity.class);
                intent.putExtra(Constants.IMAGE_PAGER_INDEX, Constants.FLOURISHING_IMAGE_INDEX);
